...
# Add GPU passthrough
qm set $VMID --hostpci0 02:00.0,pcie=1  # Video
qm set $VMID --hostpci1 02:00.1,pcie=1  # Audio
...
variable "gpu_pci_devices" {
  ...
  default = [
    {
      host_pci = "02:00.0"  # Video - UPDATE THIS
      pcie     = true
    },
    {
      host_pci = "02:00.1"  # Audio - UPDATE THIS
      pcie     = true
    }
  ]
}
...
GPU_PCI="0000:02:00.0"  # Your GPU address
...
GPU_PCI="0000:02:00.0"  # Change to your GPU
